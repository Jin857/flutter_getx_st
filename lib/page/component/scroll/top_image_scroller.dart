...
class TopImageScroller extends StatefulWidget {
  const TopImageScroller({super.key});

  @override
  State<StatefulWidget> createState() => _TopImageScrollerState();
}

class _TopImageScrollerState extends State<TopImageScroller> {
  @override
    ...
    return Scaffold(
      body: CustomScrollView(
        slivers: <Widget>[
          ...
          const SliverFillRemaining(child: FilmContent())
        ],
      ),
    );
  }
  ...
  Widget build(
    ...
    return SizedBox(
      ...
      child: Stack(
        fit: StackFit.expand,
        children: <Widget>[
          LImage(image: coverImgUrl, fit: BoxFit.cover),
          Positioned(
            left: 0,
            top: maxExtent / 2,
            right: 0,
