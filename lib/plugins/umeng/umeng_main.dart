...
class _PushState extends State<Push> with AutomaticKeepAliveClientMixin {
  ...
  void initState() {
    ...
    methods = {
      ...
      'setBadge': () async => controller.text +=
          (await UmengPushSdk.setBadge(10)).toString() + "\n",
      'cleanBadge': () async => controller.text +=
          (await UmengPushSdk.setBadge(0)).toString() + "\n",
      //添加别名
...
class UmengMain extends StatefulWidget {
  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<UmengMain> {
